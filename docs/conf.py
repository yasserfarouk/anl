#!/usr/bin/env python
#
# anl documentation build configuration file, created by
...
project = "anl"
copyright = "2023, Yasser Mohammad"
...
latex_documents = [
    (master_doc, "anl.tex", "anl Documentation", "Yasser Mohammad", "manual")
]
...
man_pages = [(master_doc, "anl", "anl Documentation", [author], 1)]
